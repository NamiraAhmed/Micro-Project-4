...
account_sid='AC71e591015d81df3031778dbf7399db45'
auth_token='efc4820d57a3b0f38fec585ef3579534'
...
def login_registration_details():
    ...
    if travel_pass <30:
        ...
        return render_template('User_Registration_Details.html',var=full_name, var1=email_id,var2=id_proof,var3=source_st,var4=source_dt,var5=destination_st,var6=destination_dt,var7=phoneNumber,var8=date,var9=status)
    else:
